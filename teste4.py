...
#logging.basicConfig(filename="test4.log",level=logging.CRITICAL ,format='%(levelname)s %(asctime)s %(name)s %(message)s')
#logging.basicConfig(filename="test4.log",level=logging.WARNING ,format='%(levelname)s %(asctime)s %(name)s %(message)s')
#logging.basicConfig(filename="test4.log",level=logging.ERROR ,format='%(levelname)s %(asctime)s %(name)s %(message)s')
